...
USE_CASES = [
    {"title": "Food & Beverage", "image": "DIKY_food_and_beverage_image.jpg", "fallback": "#f3d9b8,#c98f4e",
    ...
    {"title": "Emergency Cooling", "image": "DIKY_Emergency_cooling_image.jpg", "fallback": "#f6e0c5,#d99a5c",
     "text": "Get temporary cold support when the power goes out or refrigeration equipment stops working."},
    {"title": "Camping, Hunting & Outdoors", "image": "DIKY_Camping_Image.jpg", "fallback": "#d7e7cf,#7c9d72",
    ...
    {"title": "Science, Labs & Education", "image": "DIKY_Science_Lab_Image.jpg", "fallback": "#cfe9ec,#6ea6ad",
     "text": "Useful for demonstrations, research workflows, sample cooling, and hands-on science applications."},
    {"title": "Industrial & Maintenance", "image": "DIKY_industrial_maintenance_image.jpg", "fallback": "#dcdfe4,#8a919c",
     "text": "Support specialty cleaning, manufacturing, fitting, cooling, and maintenance processes."},
    {"title": "Agriculture & Specialty Uses", "image": "DIKY_Agriculture_Image.jpg", "fallback": "#dcebc8,#8aa85f",
